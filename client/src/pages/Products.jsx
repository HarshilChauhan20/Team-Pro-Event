...
const Products = () => {
  ...
  const getSampleProducts = () => [
    ...
    // },
    {
      ...
      category: 'chairs',
      description: 'Durable and classic Golden resin chairs that combine elegance with practicality.',
      price: 8,
      images: ['/images/chairs/golden.png'],
    ...
    //   price: 450,
    //   images: ['/images/tents/pole-tent.jpg'],
    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-light-brown">Loading products...</p>
        </div>
      </div>
    )
  }
